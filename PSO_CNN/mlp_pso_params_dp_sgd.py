...
parser.add_argument('--result_dir', default='pso_params_result/num', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='pso_params_result_nodp', type=str, help='reslult file name')
...
# 粒子个体历史最优值
perbest_V = np.ones(num)

# 粒子群体历史最优值
allbest_V = 1000000000000
...
for i in range(args.n_epoch):
    ...
    # net.state_dict()['layer1.weight'] = allbest_P[0: n1]
    # net.state_dict()['layer1.bias'] = allbest_P[n1: n2]
    # net.state_dict()['layer2.weight'] = allbest_P[n2: n3]
    # net.state_dict()['layer2.bias'] = allbest_P[n3: n4]
    # net.state_dict()['layer3.weight'] = allbest_P[n4: n5]
    # net.state_dict()['layer3.bias'] = allbest_P[n5: n6]
