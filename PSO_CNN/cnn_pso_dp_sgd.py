...
parser.add_argument('--result_dir', default='mnist_result/cnn', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_nodp', type=str, help='reslult file name')
