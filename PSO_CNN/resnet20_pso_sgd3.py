...
parser.add_argument('--result_dir', default='cifar10_result/autooptimize', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_nodp_crop_clip1_eps8', type=str, help='reslult file name')
