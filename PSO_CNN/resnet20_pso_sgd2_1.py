...
from utils1 import get_data_loader, get_sigma, restore_param, checkpoint, adjust_learning_rate, process_grad_batch
...
parser.add_argument('--n_epoch', default=100, type=int, help='total number of epochs')  # 500
...
parser.add_argument('--result_dir', default='cifar10_result/epsilonsmall_nocrop_autooptimize', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='lr0.1_result_clip1_eps1_decay', type=str, help='reslult file name')
