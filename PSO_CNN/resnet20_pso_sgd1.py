...
parser.add_argument('--result_dir', default='mnist_result/resnet20', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_clip1_eps6', type=str, help='reslult file name')
...
# p为粒子位置矩阵，初始为标准正态分布
p = np.random.randn(num, all_weight)/1000

# v为粒子速度矩阵，初始为标准正态分别
v = np.random.randn(num, all_weight)/1000
