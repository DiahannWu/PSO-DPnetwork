...
parser.add_argument('--eps', default=6., type=float, help='privacy parameter epsilon')
parser.add_argument('--delta', default=1e-5, type=float, help='desired delta')

parser.add_argument('--result_dir', default='cifar10_result/crop_autooptimize', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_clip5_eps8_decay_2', type=str, help='reslult file name')
