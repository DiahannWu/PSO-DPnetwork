...
parser.add_argument('--result_dir', default='fashion_result/resnet20', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_clip1_eps10', type=str, help='reslult file name')
