...
parser.add_argument('--result_dir', default='cifar10_result', type=str, help='reslult file dir')
parser.add_argument('--file_name', default='result_clip1_eps8_decay', type=str, help='reslult file name')
